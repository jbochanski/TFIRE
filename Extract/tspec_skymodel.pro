function tspec_skymodel, SCIIMG=sciimg, SCIIVAR=sciivar, $
  ...
  if keyword_set(DATA) then begin
     ...
     if NOT keyword_set(sciimg) OR NOT keyword_set(sciivar) then begin
        ...
        sciimg = tspec_get(data, /SCIIMG, STD=std, HDR=hdr, SCIIVAR=sciivar, VERBOSE=verbose, FILEREAD=sciimgfile)
     endif
