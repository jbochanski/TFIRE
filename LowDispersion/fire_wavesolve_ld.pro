...
savefile = getenv('FIRE_DIR')+strtrim("/LowDispersion/near_fed5.sav")
...
;xfit = fire_waveimg_ld_foo(arcimg, arcivar, tset_slits, wstruct, savefile $
;                    , fwhmset = fwhmset, qafile = qafile, AUTOID=AUTOID)
...
; xfit = mrdfits("NeNeAr_archive_fit.fits",1)
