; $Id: interpolv.pro,v 1.1.1.1 2010/09/08 20:17:25 simcoe Exp $
;
; Copyright (c) 1982-2000, Research Systems, Inc.  All rights reserved.
...
FUNCTION INTERPOLV, V, X, U, SPLINE=spline, LSQUADRATIC=ls2, QUADRATIC=quad
;+
; NAME:
;	INTERPOL
;
...
m = LONG(N_elements(v))         ;# of input pnts
