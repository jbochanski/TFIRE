...
xscalelines,(*state.d.stdspec)[*,*,stdidx],(*state.d.stdorders)[stdidx],$
            ...
            *state.d.objorders,state.d.objnaps,state.d.awave,state.d.atrans, $
...
readspec,std,std,stdhdr,stdobsmode,start,stop,stdnorders,stdnaps,stdorders,$
         stdxunits,stdyunits,slith_pix,slith_arc,slitw_pix,slitw_arc, $
         stdairmass,xtitle,ytitle

readspec,obj,obj,objhdr,objobsmode,start,stop,objnorders,objnaps,objorders,$
         objxunits,objyunits,slith_pix,slith_arc,slitw_pix,slitw_arc, $
         objairmass
...
*state.d.stddisp   = mcfxpar(stdhdr,'D*P*')
...
endif else restore, filepath('lvega5.sav',ROOT_DIR=state.r.packagepath, $
                             SUBDIR='data') 
...
;  Create hdr for the telluric correction spectrum
    ...
    fxaddpar,hdr,'OBJECT','Tellluric Correction Spectrum'
...
;  First telluric correction the object spectra
