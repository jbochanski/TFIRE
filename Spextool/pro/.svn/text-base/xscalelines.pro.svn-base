...
for i = 0,state.d.norders-1 do begin
    ...
    if count ne 0 then begin
     ...
     endif  else        array = [[array], [(max+min)/2., initscale]]  ;JJB hack.  Adds a point in the middle so spline doesn't fail for orders without a line
