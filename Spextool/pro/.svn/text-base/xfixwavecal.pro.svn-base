...
fire_readspec,istd,spc,hdr,obsmode,start,stop,ex_norders,ex_naps,ex_orders,$
...
fire_readspec,file,std_arc,junk,obsmode,dummy,dummy,dummy,dummy,std_orders,$
  xunits,yunits
...
fire_readspec,istd,spc,hdr,obsmode,start,stop,norders,naps,orders,$
  xunits,yunits,slith_pix,slith_arc,slitw_pix,slitw_arc,$
  airmass,CANCEL=cancel
...
fire_readspec,iobj,spc,hdr,obsmode,start,stop,norders,naps,orders,$
  xunits,yunits,slith_pix,slith_arc,slitw_pix,slitw_arc,$
  airmass,CANCEL=cancel
