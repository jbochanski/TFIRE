PRO update_tspecstrct_tell_info, data

	func_name = "update_tspecstrct_tell_info"
	...
	for i=0,nfiles-1 do begin
		...
		tfiles_list = list_to_names( tfiles, path=data1.rawpath )
		...
		if num_tfiles_final EQ 0 then begin
			...
			tspec_set, data1, 0, /num_tfiles
			tspec_set, data1, " ", /tfiles
			data1.tvmags = "NaN"
			data1.tbmags = "NaN"
			data1.tellname = " "		
			...
			tspec_set, data1, num_tfiles_final, /num_tfiles
			tspec_set, data1, tfiles_list_final, /tfiles
