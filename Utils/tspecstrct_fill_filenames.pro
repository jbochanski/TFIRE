...
PRO TSPECSTRCT_FILL_FILENAMES, data, OBJSTRFILE=objstrfile, MUST_EXIST=must_exist, QUIET=quiet
	...
	for i=0, nstrcts-1 do begin
		...
		strct = data[objs[i]]
		name = tspec_get( strct, /objstrfile, DONOTSET=donotset, QUIET=quiet )
